...
Try {
	...
	[string]$appName = 'Database 64-bit'
	[string]$appVersion = '11g Release 2 Client'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '09/16/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "$dirFiles\install\oui.exe" -Parameters "-silent -nowelcome -nowait -responseFile `"$dirSupportFiles\client.rsp`"" -WindowStyle "Hidden" -IgnoreExitCodes '259'

		##*===============================================
		##* POST-INSTALLATION
		##*===============================================
		[string]$installPhase = 'Post-Installation'
		Copy-File -Path "$dirSupportFiles\Admin\*" -Destination "$envSystemDrive\ORACLE11G_64\product\11.2.0\client_1\Network\Admin" -Recurse
		## <Perform Post-Installation tasks here>
		If (($envOSVersion -like "6.1*")) {
		Execute-Process -Path "reg.exe" -Parameters "import `"${dirSupportFiles}\ODBC.reg`"" -PassThru
		}
		Else {
			Add-OdbcDsn -Name "Prod" -DsnType "System" -Platform "64-bit" -DriverName "Oracle in OraClient11g_home1" -SetPropertyValue @("ServerName=PROD", "Description=Prod")
			Add-OdbcDsn -Name "Test" -DsnType "System" -Platform "64-bit" -DriverName "Oracle in OraClient11g_home1" -SetPropertyValue @("ServerName=TEST", "Description=Test")
		}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUGRcvvK2pbv12yM21RTjHPISy
# iV2ggguhMIIFrjCCBJagAwIBAgIQBwNx0Q95WkBxmSuUB2Kb4jANBgkqhkiG9w0B
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRECi9w6q4SoF0D
# T9Y8I5LF9iBctTANBgkqhkiG9w0BAQEFAASCAQCVtpURayBImlZBa2jj87BJAzjL
# 0gXkyl1Z7E0FNM75FXUSS0EmJ7igLur5ytBMXyTfZORgqeV1t1oKMVHYdKKlA4f4
# 0969Bq9RpY3+7Khqoez5VohnpauOMXjKgnN7kqcl4MjHmVpIee4m7rqSr4Pbhks5
# VJ4JTsYdAodsGtfsREfCelEswRCWNkowChYjyLBdhfBIPCpat3oiFh7B6c1j3JuC
# td37vPQZIsuQ9xxjahXFWGSJbtFGFhpKnxoF9kmTgGD06rU5HVuH7n9gQymcUDdy
# 4YijNLlWZnqkVsc9m+zNj1CUKrLmD2RokVGxyp+ry3j9WhjYshFJ2LNGCP60
